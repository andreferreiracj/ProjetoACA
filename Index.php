...
if(strtolower($data['content']) == '!horror') {
    ...
    "horror","Ari Aster","https://www.imdb.com/title/tt7784604/");
     ...
     "horror","Ari Aster","https://www.imdb.com/title/tt8772262/?ref_=nv_sr_srsg_0");
     ...
     "horror","William Friedkin","https://www.imdb.com/title/tt0070047/?ref_=fn_al_tt_1");
     ...
     "horror","John Carpenter","https://www.imdb.com/title/tt0077651/?ref_=fn_al_tt_1");
...
if(strtolower($data['content']) == '!drama') {
  ...
  "drama","Thomas Vinterberg","https://www.imdb.com/title/tt10288566/");
  ...
  "drama","Mel Gibson","https://www.imdb.com/title/tt2119532/?ref_=nv_sr_srsg_0");
  ...
  "drama","Eliza Hittman","https://www.imdb.com/title/tt7772582/?ref_=fn_al_tt_1");
  ...
  "drama","Gus Van Sant","https://www.imdb.com/title/tt0119217/?ref_=fn_al_tt_1");
...
if(strtolower($data['content']) == '!action') {
  $film9 = new film("Bad Boys","Two hip detectives protect a witness to a murder while investigating a case of stolen heroin from the evidence storage room from their police precinct.",
   ...
   "action","Christopher Nolan","https://www.imdb.com/title/tt6723592/?ref_=fn_al_tt_1");
   ...
   "action","Lana Wachowski and Lilly Wachowski ","https://www.imdb.com/title/tt0133093/?ref_=nv_sr_srsg_2");
...
if(strtolower($data['content']) == '!thriller') {
  ...
  "Thriller","Dan Gilroy","https://www.imdb.com/title/tt2872718/?ref_=nv_sr_srsg_0");
  ...
  "Thriller","Bong Joon Ho","https://www.imdb.com/title/tt6751668/?ref_=nv_sr_srsg_0");
  ...
  "Thriller","David Fincher","https://www.imdb.com/title/tt0137523/?ref_=nv_sr_srsg_0");
  ...
  "Thriller","Antonio Campos","https://www.imdb.com/title/tt7395114/?ref_=fn_al_tt_1");
...
if(strtolower($data['content']) == '!comedy') {
  ...
  "comedy","Frank Oz","https://www.imdb.com/title/tt0795368/?ref_=nv_sr_srsg_0");
  ...
  "comedy","Edgar Wright","https://www.imdb.com/title/tt0446029/?ref_=nv_sr_srsg_0");
  ...
  "comedy","Phil Lord and Christopher Miller","https://www.imdb.com/title/tt1232829/");
  ...
  "comedy","Seth MacFarlane","https://www.imdb.com/title/tt1637725/?ref_=fn_al_tt_1");
